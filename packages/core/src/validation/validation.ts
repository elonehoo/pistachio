...
import { NO_OP, isBoolean, isObject, isPromise, unwrap, wrap } from '../utils'
...
interface ValidatorObject<TValidator extends ValidatorFunc<any>> {
...
const buildValidation = <T>(
  ...
  for (const k of Object.keys(o)) {
    ...
    if ($value) {
      ...
      let $anyDirty: Ref<boolean> | undefined
